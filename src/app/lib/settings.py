...
class AppSettings(BaseSettings):
    ...
    @classmethod
    def generate_secret_key(cls, value: str | None, info: FieldValidationInfo) -> SecretBytes:  # noqa: ARG003
...
class HTTPClientSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(case_sensitive=True, env_file=".env", env_prefix="HTTP_", extra="ignore")
