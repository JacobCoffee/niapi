...
def exception_to_http_response(request: Request, exc: Exception) -> Response:
    ...
    if isinstance(exc, NotFoundError):  # type: ignore[arg-type]
        http_exc = NotFoundException
    elif isinstance(exc, ConflictError):  # type: ignore[arg-type]
